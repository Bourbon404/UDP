...
function (paramArray){
	var array=[
		...
		{type:MESSAGE_PARAM_TYPE.STRING,length:20,name:"FriendName"},
		...
		{type:MESSAGE_PARAM_TYPE.STRING,length:1,name:"Status"},
		{type:MESSAGE_PARAM_TYPE.STRING,length:1,name:"AgreePosition"},
